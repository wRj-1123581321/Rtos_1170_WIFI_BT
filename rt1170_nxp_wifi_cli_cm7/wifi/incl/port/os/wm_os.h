...
#define OS_PRIO_4 (CONFIG_WIFI_MAX_PRIO - 4)
#define OS_PRIO_5 (CONFIG_WIFI_MAX_PRIO - 5)
#define OS_PRIO_6 (CONFIG_WIFI_MAX_PRIO - 6)
#define OS_PRIO_7 (CONFIG_WIFI_MAX_PRIO - 7)/** Low **/
